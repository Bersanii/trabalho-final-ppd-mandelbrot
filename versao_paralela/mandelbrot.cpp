...
/*
	Converte um ponto z de um plano para outro. O ponto z é representado como um numero complexo. 
	O plano antigo e o novo plano sao passados como parametros.
...
/*
	Converte um ponto (x,y) da imagem em um numero complexo, retornando o ponto convertido
	multiplicado pelo centro do conjunto de mandelbrot
*/
...
/*
	Verifica se um ponto (s,t) escapou do conjunto de maldelbrot.
*/
...
/*
	Essa função define qual caractere deve representar um ponto do conjunto de maldelbrot.
	Ela recebe uma coordenada no plano complexto (x,y) e retorna o caractere que representa o ponto.
...
/*
	Essa funcao é responsavel por preencher uma região retangular da imagem com um certo caractere.
	Recebe como parametro a posicao inicial(x,y), largura e altura do retangulo e o caractere
	que sera usado para o preenchimento
...
/*
	Funcao que gera a imagem do conjunto de maldelbrot.
	Ela verifica se a imagem precisa ser atualizada e, caso precise, ela cria a imagem.
